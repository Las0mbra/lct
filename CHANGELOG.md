...
## v1.10.4
- Quick update for Battlemaster maps that got the new dataslate maps. There might be some issues with objectives, that i ll fix with a latter update but I felt it's more important to have the maps ready for people to play. 
